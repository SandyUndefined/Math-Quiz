...
import com.sandy.quiz.adapter.HistoryAdapter;
...
import static com.sandy.quiz.ui.MainActivity.rate;
import static com.sandy.quiz.utils.Constant.sendFeedback;
import static com.sandy.quiz.utils.ConstantDialog.addWatermark;
import static com.sandy.quiz.utils.ConstantDialog.combineImages;
...
//    public boolean checkPermission34(Context context) {
//        int i3 = 0;
//        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.R) {
//            i3 = ContextCompat.checkSelfPermission(context, Manifest.permission.MANAGE_EXTERNAL_STORAGE);
//        }
//        return i3 == PackageManager.PERMISSION_GRANTED;
//    }
...
//    public void requestPermission34() {
...
//            }
    ...
    public void shareImage() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
            ...
            photoURI = FileProvider.getUriForFile(getApplicationContext(), "com.sandy.quiz.provider", file1);
        } else {
